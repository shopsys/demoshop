 ...
 * @method \App\Model\Customer\User create(\App\Model\Customer\CustomerData $customerData)
 * @method \App\Model\Customer\User edit(int $userId, \App\Model\Customer\CustomerData $customerData)
 ...
 * @method \App\Model\Customer\User editByAdmin(int $userId, \App\Model\Customer\CustomerData $customerData)
 * @method \App\Model\Customer\User editByCustomer(int $userId, \App\Model\Customer\CustomerData $customerData)
...
class CustomerFacade extends BaseCustomerFacade
{
    ...
    /**
     * @param \App\Model\Customer\BillingAddress $billingAddress
     * @param \App\Model\Customer\CustomerData $companyData
     */
    ...
    /**
     * @param \App\Model\Customer\User $companyUser
     * @param \App\Model\Customer\CustomerData $newCompanyData
     */
     ...
     * @param \App\Model\Customer\CustomerData $companyData
     * @param \App\Model\Customer\BillingAddress $billingAddress
     * @param \App\Model\Customer\UserData[] $newCompanyUsersData
     */
